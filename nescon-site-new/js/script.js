  ...
  $(document).ready(function () {
    ...
    function pageSlider() {
      $(".page-slider").slick({
        ...
        arrows: true,
        prevArrow:
          '<button type="button" class="carousel-control left" aria-label="carousel-control"><i class="fa fa-chevron-left"></i></button>',
        nextArrow:
          '<button type="button" class="carousel-control right" aria-label="carousel-control"><i class="fa fa-chevron-right"></i></button>',
      });
    }
    pageSlider();
